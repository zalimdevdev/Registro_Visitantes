...
{
    /// <inheritdoc />
    public partial class InitialVisitanteMigration : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sexo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EdadVisitantes = table.Column<int>(type: "int", nullable: true),
                    ...
                    Nacionalidad = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PaisDeOrigen = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InfoVisitantes", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
        }
